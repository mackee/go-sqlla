...
// IterContext returns iter.Seq2[UserItem, error] and closer.
//
...
func (q userItemSelectSQL) IterContext(ctx context.Context, db sqlla.DB) (func(func(UserItem, error) bool), func() error) {
	...
	q.Columns = userItemAllColumns
	query, args, err := q.ToSql()
	return func(yield func(UserItem, error) bool) {
		if err != nil {
			var r UserItem
			yield(r, err)
			return
